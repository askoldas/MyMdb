...
import { Dropdown } from '@/ui/elements/Dropdown'; // Use your custom Dropdown component
...
export function GenreSelection({ onChange, value = [] }) {
  ...
  // Ensure selected genres are synced with the parent component
  useEffect(() => {
    if (value) {
  ...
  return (
    <div className="genre-selection">
      ...
      {/* Use the Dropdown component here for genre selection */}
      <Dropdown
