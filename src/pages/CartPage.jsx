...
export function CartPage() {
  ...
  if (loading) return <Page><div className="loading">Loading your cart...</div></Page>
  if (error) return <Page><div className="error">Error: {error}</div></Page>
  if (items.length === 0) return <Page><div className="empty-cart">Your cart is empty.</div></Page>
